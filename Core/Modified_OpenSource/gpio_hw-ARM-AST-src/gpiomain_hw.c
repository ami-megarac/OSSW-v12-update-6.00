...
#ifdef CONFIG_SPX_FEATURE_GLOBAL_CORE_2019
static int gpio_irq;
...
#ifndef CONFIG_SPX_FEATURE_GLOBAL_CORE_2019
...
#ifdef CONFIG_SPX_FEATURE_GLOBAL_CORE_2019
			IRQ_SET_HIGH_LEVEL (gpio_irq);
   			IRQ_SET_LEVEL_TRIGGER (gpio_irq);
#else
...
#ifdef CONFIG_SPX_FEATURE_GLOBAL_CORE_2019
				EXT_IRQ_SET_HIGH_LEVEL (sgpio_master_irq);
				EXT_IRQ_SET_LEVEL_TRIGGER (sgpio_master_irq);
#else
