...
#define PHYS_P4_USBD_IRQ_HUB					62
#define PHYS_P4_USBD_IRQ_DEV0				63
#define PHYS_P4_USBD_IRQ_DEV1				64
#define PHYS_P4_USBD_IRQ_DEV2				65
#define PHYS_P4_USBD_IRQ_DEV3				66
#define PHYS_P4_USBD_IRQ_DEV4				67
#define PHYS_P4_USBD_IRQ_DEV5				68
#define PHYS_P4_USBD_IRQ_DEV6				69
...
// reset USB HW for B4 issue with DMA mode. solution by Pilot FAE.
/********************************************************************
   Internal Register Mapping (0x40000000 to 0x40AFFFFF) 
*********************************************************************/
#define SE_REGISTER_BASE				0x40000000
#define P4_LPC_ROM_BASE                	(SE_REGISTER_BASE + 0x0100000)	 	/* 256  */
