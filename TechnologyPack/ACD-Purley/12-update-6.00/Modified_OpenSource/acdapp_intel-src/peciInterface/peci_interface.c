...
#define PECI_XMIT_FEEDBACK	0x0
#define PECI_AWFCS			0x0
...
static int SendPECICmd(void * peciReq, int reqSize, int cmdType, void * peciRes)
{
    ...
    if (cmdType == RD_PKG_CFG_REQ)
    {
   	...
   	PECICmd.target = RdPkgConfigReq->sHeader.u8ClientAddr;
        ...
        PECICmd.Xmit_Feedback = PECI_XMIT_FEEDBACK; //Xmit_Feedback;
	PECICmd.AWFCS = PECI_AWFCS; //awfcs;
...
//---0.7--
         psRdPkgConfigRes->u8CompletionCode = PECI_CC_DRIVER_ERROR;
//--------
	// System specific code goes here.
...
//-----0.7---
         psWrPkgConfigRes->u8CompletionCode = PECI_CC_DRIVER_ERROR;
//--------
	// System specific code goes here.
...
//---0.7--
         psRdPCIConfigLocalRes->u8CompletionCode = PECI_CC_DRIVER_ERROR;
//--------
	// System specific code goes here.
